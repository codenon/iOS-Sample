...
- (instancetype)init {
  ...
  if (self) {
    ...
    _tableview.backgroundColor = [UIColor colorWithRed:84 / 255.0
                                                 green:142 / 255.0
                                                  blue:212 / 255.0
                                                 alpha:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  if (cell == nil) {
    ...
    cell.contentView.backgroundColor = [UIColor colorWithRed:84 / 255.0
                                                       green:142 / 255.0
                                                        blue:212 / 255.0
                                                       alpha:1];
    cell.backgroundColor = [UIColor colorWithRed:84 / 255.0
                                           green:142 / 255.0
                                            blue:212 / 255.0
                                           alpha:1];
  ...
  AMapLocalDayWeatherForecast *dayForecast =
      [_forecastArray objectAtIndex:indexPath.row];
  NSString *title = [dayForecast.date substringFromIndex:5];
  title = [title stringByReplacingOccurrencesOfString:@"-" withString:@"/"];
  cell.textLabel.text =
      [title stringByAppendingString:_weekDict[dayForecast.week]];

  NSString *subTitle =
      [NSString stringWithFormat:@"%@/%@", dayForecast.dayTemp ?: @"",
