...
@interface SubPoiListViewController () <UITableViewDataSource,
                                        UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  UITableViewCell *cell =
      [tableView dequeueReusableCellWithIdentifier:subPoiList];

  if (cell == nil) {
    cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle
                                  reuseIdentifier:subPoiList];
  }
...
- (void)tableView:(UITableView *)tableView
  ...
  SubPoiDetailViewController *controller =
      [[SubPoiDetailViewController alloc] init];
