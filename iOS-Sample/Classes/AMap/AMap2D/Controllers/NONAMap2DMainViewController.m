...
@interface NONAMap2DMainViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation NONAMap2DMainViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BaseAMap2DMapViewController *subViewController = [[NSClassFromString(className) alloc] init];
